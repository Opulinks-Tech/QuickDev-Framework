...
#define BLE_GAP_PF_DEVICE_NAME                  "OPL_AWS"
#endif

// <o> MQTT_DEMO_PERI_POST_EN - enable periodic post data
#ifndef MQTT_DEMO_PERI_POST_EN
#define MQTT_DEMO_PERI_POST_EN                  (0)
#endif

// <o> MQTT_DEMO_PERI_POST_INTERVAL - periodic post data interval time (ms)
#ifndef MQTT_DEMO_PERI_POST_INTERVAL
#define MQTT_DEMO_PERI_POST_INTERVAL            (5000)
#endif

// </h> Share Memeory Setting
#if defined(OPL1000_A2) || defined(OPL1000_A3)  // Only for opl1000
//#if 1
