...
//==========================================================
// <h> http get / http post
//==========================================================

// <e> HTTP_ENABLED - AT command http get and http post
//==========================================================
// #ifndef HTTP_ENABLED
#if defined(OPL_AWS_HTTP)
#define HTTP_ENABLED                            (1)
#else
#define HTTP_ENABLED                            (0)
#endif

#if(OTA_ENABLED == 1 || OPL_DATA_ENABLED == 1)
#undef HTTP_ENABLED
#define HTTP_ENABLED                            (0)
#endif
...
#if defined(OPL_MODULE)
#define CLOUD_ENABLED                           (0)
#define AWS_ENABLED                             (0)
#endif
