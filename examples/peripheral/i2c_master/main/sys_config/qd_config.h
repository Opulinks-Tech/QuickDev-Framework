...
// If 2500, build M25P for default
#ifdef OPL2500_A0
...
// <o> APP_DEF_AP_SSID - default linked AP ssid
#ifndef APP_DEF_AP_SSID
#define APP_DEF_AP_SSID                         "dlink"
#endif

#ifndef APP_QSET_AP_SSID
#define APP_QSET_AP_SSID                        "hatest"
#endif

// <o> APP_DEF_AP_BSSID - default linked AP bssid
#ifndef APP_DEF_AP_BSSID
#define APP_DEF_AP_BSSID                        {0x11,0x22,0x33,0x44,0x55,0x66}
#endif

// <o> APP_DEF_AP_PWD - default linked AP password
#ifndef APP_DEF_AP_PWD
#define APP_DEF_AP_PWD                          "12345678"
#endif

#ifndef APP_QSET_AP_PWD
#define APP_QSET_AP_PWD                         "12345678"
#endif

// <o> APP_WIFI_SCAN_RETRY_TIME - Wi-Fi scan retry interval (ms)
#ifndef APP_WIFI_SCAN_RETRY_TIME
#define APP_WIFI_SCAN_RETRY_TIME                5000
#endif

// Deep sleep IO configuration
#define WAKEUP_IO_PORT                          (GPIO_IDX_09)
