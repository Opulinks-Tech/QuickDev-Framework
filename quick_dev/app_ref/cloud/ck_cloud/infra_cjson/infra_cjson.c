...
internal_hooks global_hooks = { internal_malloc, internal_free, NULL };
cJSON_bool print_value(const lite_cjson_item_t *const item, printbuffer *const output_buffer);
