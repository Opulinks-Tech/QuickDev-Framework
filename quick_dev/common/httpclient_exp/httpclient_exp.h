...
#ifndef __HTTPCLIENT_EXP_H__
#define __HTTPCLIENT_EXP_H__

#ifdef __cplusplus
extern "C" {
#endif

#define HTTPCLIENT_EXP
...
typedef enum {
    ...
    HTTPCLIENT_DELETE_T,
    HTTPCLIENT_HEAD_T
} HTTPCLIENT_REQUEST_TYPE_T;

/** @brief   This enumeration defines the API return type.  */
typedef enum {
    HTTPCLIENT_ERROR_PARSE_T = -6,           /**< A URL parse error occurred. */
    HTTPCLIENT_UNRESOLVED_DNS_T = -5,        /**< Could not resolve the hostname. */
    HTTPCLIENT_ERROR_PRTCL_T = -4,           /**< A protocol error occurred. */
    HTTPCLIENT_ERROR_T = -3,                 /**< An unknown error occurred. */
    HTTPCLIENT_CLOSED_T = -2,                /**< Connection was closed by a remote host. */
    HTTPCLIENT_ERROR_CONN_T = -1,            /**< Connection failed. */
    HTTPCLIENT_OK_T = 0,                     /**< The operation was successful. */
    HTTPCLIENT_RETRIEVE_MORE_DATA_T = 1      /**< More data needs to be retrieved. */
} HTTPCLIENT_RESULT_T;
